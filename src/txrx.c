...
void transmit_task(void *args) {
    while (1) {
        ...
        vTaskDelay(pdMS_TO_TICKS(50)); // Delay between transmissions
    }
}
...
//     tx_message.id = 0x123; //lower ID = lower priority
//     tx_message.dlc = 3;
//     tx_message.data[0] = 1;
//     tx_message.data[1] = 0;
//     tx_message.data[2] = 1;
...
//     xTaskCreate(transmit_task, "SideThread",
//                 configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 1UL, &task2);
//     vTaskStartScheduler();
//     return 0;
// }